	...
	if(isset($font_data) && count($font_data) >= 2) {
		...
		if($this->API->get('font_rules_group'.$font_iter, '') != ''){
			if($font_type == 'standard') {
				...
				$font_link = str_replace('&', '&amp;', $font_data[2]);
...
if($this->API->get('use_lazyload', '1') == 1) {
          echo '<script type=\'text/javascript\' data-excluded=\''.str_replace("=Disabled\r\n", ",",$this->API->get('lazyload_for_pages', 'null')).'\' id=\'gkLazyLoad\' src=\''.$this->API->URLtemplate().'/js/lazyload.js\' ></script>';
}
...
<!--[if IE 9]><link rel="stylesheet" href="<?php echo $this->API->URLtemplate(); ?>/css/ie/ie9.css" type="text/css" /><![endif]-->
<!--[if IE 8]><link rel="stylesheet" href="<?php echo $this->API->URLtemplate(); ?>/css/ie/ie8.css" type="text/css" /><![endif]-->
<!--[if lte IE 7]><link rel="stylesheet" href="<?php echo $this->API->URLtemplate(); ?>/css/ie/ie7.css" type="text/css" /><![endif]-->
