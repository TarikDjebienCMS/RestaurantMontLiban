...
<section id="k2Container" class="userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<?php if ($this->params->get('userImage') || $this->params->get('userName') || $this->params->get('userDescription') || $this->params->get('userURL') || $this->params->get('userEmail')): ?>
  	...
  	<section class="itemList">
		...
		<article class="itemView<?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' itemViewUnpublished'; ?><?php echo ($item->featured) ? ' itemIsFeatured' : ''; ?> clearfix"> 
			<?php echo $item->event->BeforeDisplay; ?> 
			<?php echo $item->event->K2BeforeDisplay; ?>
			
			<?php if($item->params->get('userItemDateCreated')): ?>
			<time datetime="<?php echo JHTML::_('date', $item->created , JText::_('d M Y h:i')); ?>">
			...
			<header>
				...
				<ul>				            
				    ...
				    <li class="itemComments">
				        ...
				        <?php else: ?>
				            <a href="<?php echo $item->link; ?>#itemCommentsAnchor" class="itemCommentsLink">
