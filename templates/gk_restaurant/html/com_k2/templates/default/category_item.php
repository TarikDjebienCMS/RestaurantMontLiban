	    ...
	    <header>
            ...
            <ul>
        		...
        		<li class="itemComments">    
        		    <a href="<?php echo $this->item->link; ?>#itemCommentsAnchor" class="itemCommentsLink">
	            ...
	            <li class="itemHitsBlock">
	                  <span class="itemHits"><?php echo JText::_('K2_READ'); ?>: <?php echo $this->item->hits; ?> 
