...
<form action="<?php echo JRoute::_('index.php?option=com_k2store&view=orders')?>" method="post" name="adminForm" enctype="multipart/form-data">
				...
				<table class="userTable" width="100%">
						<thead>
								<tr class="jorder_rowhead">
										...
										<th width="15%"> <?php echo JText::_('Order Date'); ?> </th>
										<th width="15%"> <?php echo JText::_('Invoice No'); ?> </th>
										<th width="15%"> <?php echo JText::_('Order ID'); ?> </th>
										<th width="10%"> <?php echo JText::_('Total'); ?> </th>
										<th width="10%"> <?php echo JText::_('Order Status'); ?> </th>
								</tr>
						</thead>
						<tfoot>
								<tr>
										<td colspan="6" class="jorder_row"><div style="float: right; padding: 5px;"><?php echo @$this->pagination->getResultsCounter(); ?></div>
		...
		?>
								<tr class="k2store_order_<?php echo "row$k"; ?>">
										...
										<td><?php echo JHTML::_('date', $row->created_date, '%d-%m-%Y'); ?></td>
										<td><?php echo $row->id; ?></td>
										<td><a href='<?php echo $link; ?>'><?php echo $row->order_id; ?></a></td>
										<td><?php echo K2StoreUtilities::number( $row->orderpayment_amount, array( 'thousands'=>'' ) ); ?></td>
