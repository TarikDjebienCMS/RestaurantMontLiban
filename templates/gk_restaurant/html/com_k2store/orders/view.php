...
<div id="items_info">
		...
		<table id="cart_order" class="" style="clear: both;">
				...
				<tfoot>
						<tr>
								<td colspan="2" style="text-align: right;"><?php echo JText::_( "Subtotal" ); ?></td>
								<td style="text-align: right;"><?php echo K2StorePrices::number($order->order_subtotal); ?></td>
						</tr>
						<tr>
                    ...
                    ?>
								...
								<td style="text-align: right;"><?php echo K2StorePrices::number($row->order_tax); ?></td>
						</tr>
						<tr>
								<td colspan="2" style="text-align: right;"><?php echo JText::_( "Shipping" ); ?></td>
								<td style="text-align: right;"><?php echo K2StorePrices::number($row->order_shipping); ?></td>
						</tr>
						<tr>
								<td colspan="2" style="text-align: right;"><?php 
            ...
            ?></td>
								<td style="text-align: right;"><?php echo K2StorePrices::number($row->order_discount); ?></td>
						</tr>
						<tr>
								<td colspan="2" style="font-size: 120%; text-align: right;"><?php echo JText::_( "Total" ); ?></td>
								<td class="cart_subtotal_price"><?php echo K2StorePrices::number($row->order_total); ?></td>
						</tr>
				</tfoot>
		</table>
</div>
