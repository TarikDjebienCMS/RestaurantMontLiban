...
<form action="<?php echo $action; ?>" method="post" class="adminform" id="<?php echo $formName; ?>" name="<?php echo $formName; ?>" enctype="multipart/form-data" >
    ...
    ?>
				...
				<div id='product_quantity_input_<?php echo $item->product_id; ?>' class="product_quantity_input"> <span class="title"><?php echo JText::_( "Quantity" ); ?>:</span>
		...
		<!-- Add to cart button -->
		<div id='add_to_cart_<?php echo $item->product_id; ?>' class="add_to_cart">
