...
<table class="billing_shipping" width="100%">
		<tr>
				...
				<td valign="top"><div class="k2storeShippingAddress">
				...
				<td valign="top"><div class="showShipping">
								<h3><?php echo JText::_('Shipping Information'); ?></h3>
								<?php echo $this->order->shipping->shipping_name; ?> </div></td>
				<?php endif; ?>
		</tr>
</table>
<form name="userForm" class="form-validate" id="userForm" method="post" action="<?php echo $action; ?>" <?php echo $js_validation; ?> >
		<div id='onCheckoutPayment_wrapper'>
				...
				<?php echo JText::_( $plugin->name ); ?> <br/>
				<?php
                    }
                }
            ?>
		...
		<div class="clr"></div>
		<div id="checkbox_tos">
				<input type="checkbox" class="required" id="k2store_tos" name="k2store_tos" value="1" />
				<label for="k2store_tos"> <?php echo K2StorePopup::popup($this->tos_link, JText::_('Terms and Conditions')); ?> </label>
		</div>
