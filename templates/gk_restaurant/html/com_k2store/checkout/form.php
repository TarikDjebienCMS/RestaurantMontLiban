...
<div class="k2store_users">
		<div class='componentheading'> <span><?php echo JText::_( "Returning Users" ); ?></span> </div>
		...
		<form action="<?php echo JRoute::_( 'index.php?option=com_k2store', true, $this->params->get('usesecure')); ?>" method="post" name="login" id="form-login" >
				<div> <?php echo JText::_('USERNAME'); ?> <br />
						<input type="text" name="username" class="inputbox" size="60" alt="username" />
				</div>
				<div> <?php echo JText::_('PASSWORD'); ?> <br />
						<input type="password" name="password" class="inputbox" size="60" alt="password" />
				</div>
				<div> <?php echo JText::_('REMEMBER ME'); ?> 
...
<div class="k2storeNewusers"> 
		...
		<div class='componentheading'> <span><?php echo JText::_( "New Users" ); ?></span> </div>
...
<div class="k2storeGuests">
		<div class='componentheading' style="margin-top:15px;"> <span><?php echo JText::_( "Checkout as a Guest" ); ?></span> </div>
		<!-- REGISTRATION --> 
