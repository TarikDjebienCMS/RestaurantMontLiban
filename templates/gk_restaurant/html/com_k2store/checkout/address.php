...
<div class="k2storeOrderSummary"> <?php echo @$this->orderSummary; ?> </div>
<div class="shipping_address_form" >
		...
		<table>
				<tbody>
						<tr>
								<td  class="key"><?php echo JText::_( 'First name' ); ?> * </td>
						...
						<tr>
								<td  class="key"><?php echo JText::_( 'Last name' ); ?> * </td>
			           ...
			           class="required"
						...
						<tr>
								<td  class="key"><?php echo JText::_( 'Address Line 1' ); ?> * </td>
								<td><input type="text" name="address_1"
			            class="required"
			            id="address_1" size="48" maxlength="250" 
			            value="<?php echo @$row->address_1; ?>" /></td>
						</tr>
						<tr>
								<td  class="key"><?php echo JText::_( 'Address Line 2' ); ?></td>
								<td><input type="text" name="address_2"
			            id="address_2" size="48" maxlength="250" 
			            value="<?php echo @$row->address_2; ?>" /></td>
						</tr>
						<tr>
						...
						<tr>
								...
								<td><input type="text" name="phone_1" id="phone_1"
						class="required"
						size="25" maxlength="250" 
						value="<?php echo @$row->phone_1; ?>" /></td>
						</tr>
						<tr>
								<td  class="key"><?php echo JText::_( 'Mobile' ); ?></td>
								<td><input type="text" name="phone_2" id="phone_2"
						size="25" maxlength="250"
						value="<?php echo @$row->phone_2; ?>" /></td>
						</tr>
						<tr>
