...
<article<?php if ($this->item->state == 0) : ?> class="system-unpublished"<?php endif; ?>>	
	...
	<gavern:desktop>
		...
		<ul>
            ...
            <gavern:mobile>
				<?php if ($params->get('show_create_date')) : ?>
                    <li><time datetime="<?php echo JHtml::_('date', $this->item->created, JText::_('d M Y h:i')); ?>">
                        <strong><?php echo JHtml::_('date', $this->item->created, JText::_('d M')); ?></strong>
                    </time>
                    </li>
                <?php endif; ?>
             </gavern:mobile>
		...
		<?php endif; ?>
	<gavern:desktop></header></gavern:desktop>
	<?php endif; ?>
